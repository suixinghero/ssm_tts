...
<div id="main">
    ...
    <form action="<%=request.getContextPath()%>/role/updateRole" method="post" class="main_form" id="loginForm">
        <div class="text_info clearfix"><span>角色名称：</span></div>
        <div class="input_info">
            <input type="text" class="width200" value="${role.rname}" name="rname" id="roleName" />
        ...
        <div class="button_info clearfix">
            ...
            <input type="button" value="保存" class="btn_save" id="goUpdateRole"/>
